...
The fraction of squared norm for on manifold deviation out of the
total deviation
\begin{align*}
\rho=\frac{\mathbb{E}[\|P^{\parallel}\Delta\theta\|^{2}]}{\mathbb{E}[\|\Delta\theta\|^{2}]} & =\frac{\mathbb{E}[\|P^{\parallel}\Delta\theta\|^{2}]}{\mathbb{E}[\|P^{\parallel}\Delta\theta\|^{2}]+\mathbb{E}\|P^{\perp}\Delta\theta\|^{2}}\\
...
\begin{figure}[h]
\centering \begin{tikzpicture}[scale=1.0, every node/.style=font=\small]
        ...
        \end{tikzpicture} \caption{Wick contraction classes for $\mathbb{E}[(\epsilon^{\top}Q\epsilon)^{2}\,\epsilon_{e}\epsilon_{f}]$,
with external loose ends $e,f$ shown as crosses.}
\end{figure}
